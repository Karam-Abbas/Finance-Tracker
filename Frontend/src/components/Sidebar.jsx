...
const NavLink = ({ to, icon: Icon, children }) => (
  <Link
    to={to}
    className="flex items-center space-x-3 rounded-lg px-3 py-2 text-sm text-gray-700 transition-colors hover:bg-gray-200 hover:text-gray-900"
  >
...
const Sidebar = () => {
  ...
  return (
    <div className="flex h-screen w-64 flex-col px-4 py-6">
      {/* User Profile Section */}
      <div className="mb-8 flex items-center space-x-4 px-2">
